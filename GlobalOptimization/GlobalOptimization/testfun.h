...
namespace testfun
{
	...
	const vector<double> lb = { -5.12, -2.048, -1.28, -5.12, -500, -600, -30, -2, -5, -100, -10, -1, -1, -512, -10, -10, -10, -500, -pi, -10 }; /*левые границы области определения*/
	const vector<double> rb = { 5.12, 2.048, 1.28, 5.12, 500, 600, 30, 2, 5, 100, 10, 4, 1, 512, 10, 10, 10, 500, pi, 10 }; /*правые границы бласти определения*/ /*=> область определения*/
	const vector<string> namefun = { "Sphere", "Rosenbrock", "Gauss Quartic", "Rastrigin", "Schwefel", "Griewank", "Ackley", "RastriginNovgorod", "StepFunction", "Salomon", "Alpine1", "Brown", "Deb1", "Egg Holder", "Pinter", "Shubert3", "Streched V Sine Wave", "Trigonometric2", "Wavy", "Whitley" };/*имена функций*/
